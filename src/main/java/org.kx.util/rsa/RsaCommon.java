...
public class RsaCommon {
    ...
    private static String filePath = System.getProperty("user.home") + File.separator + "Downloads"+ File.separator + "systemConf"+ File.separator + "kin" + File.separator + "xs.txt";
