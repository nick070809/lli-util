...
public class MarkDownParser {
    ...
    public String toHtmlString() {
        ...
        sn.append("<!DOCTYPE html>\n");
        sn.append("<html>\n");
        sn.append("<head>\n");
        sn.append("<title>" + fileName + "</title>\n");
        sn.append("<meta http-equiv='Content-Type' content='text/html; charset=utf-8' />\n");
        sn.append("<link type='text/css' rel='stylesheet' href='main.css'/>\n");
        sn.append("</head>\n");
        sn.append("<body>\n");
        // 写入 html 主体
        if (mdListType.size() == mdList.size()) {
            for (int i = 0; i < mdList.size(); i++) {
                sn.append(mdList.get(i)).append("\n");
            }
        }
        // 写入 html 尾部
        sn.append("</body>\n");
